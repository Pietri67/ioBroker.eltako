...
var cliStates_exports = {};
__export(cliStates_exports, {
  CLIStates: () => CLIStates
});
module.exports = __toCommonJS(cliStates_exports);
...
class CLIStates extends import_cliCommand.CLICommand {
  ...
  execute(args) {
    ...
    switch (command) {
      case "get":
        resultTransform = (obj) => (0, import_cliTools.formatValue)(obj, pretty);
      ...
      case "getplain":
        resultTransform = (obj) => {
          ...
          return [obj.val, obj.ack, obj.from, obj.ts, obj.lc].map((line) => (0, import_cliTools.formatValue)(line)).join("\n");
        };
        return this.get_(args, resultTransform);
      case "getValue":
      case "getvalue":
        resultTransform = (obj) => obj ? (0, import_cliTools.formatValue)(obj.val, pretty) : "null";
        return this.get_(args, resultTransform);
      case "set":
            ...
            objects.getObject(aliasId, async (_err, sourceObj) => {
              try {
                ...
                if (!state) {
                  ...
                  import_js_controller_common.tools.formatAliasValue({
  ...
  set_(args) {
    ...
    dbConnect((params) => {
      const { states, objects } = params;
      const newVal = ack === void 0 ? { val, ack: false } : { val, ack: !!ack };
      if (id.startsWith(ALIAS_STARTS_WITH)) {
        objects.getObject(id, async (_err, obj) => {
          ...
          if (obj && obj.common && obj.common.alias && obj.common.alias.id) {
            ...
            objects.getObject(aliasId, (err, targetObj) => {
              ...
              states.setState(aliasId, import_js_controller_common.tools.formatAliasValue({
                ...
                if (err2) {
                  CLI.error.unknown(err2.message);
                  return void callback(1);
                }
        ...
        objects.getObject(id, async (err, obj) => {
          ...
          states.setState(id, newVal, (err2) => {
            if (err2) {
              CLI.error.unknown(err2.message);
              return void callback(1);
            }
...
//# sourceMappingURL=cliStates.js.map
