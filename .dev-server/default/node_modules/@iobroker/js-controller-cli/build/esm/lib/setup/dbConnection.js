...
import { getObjectsConstructor, getStatesConstructor, objectsDbHasServer, statesDbHasServer, } from '@iobroker/js-controller-common';
 ...
 * @param callback
 */
export async function dbConnect(onlyCheck, params, callback) {
 ...
 */
export function dbConnectAsync(onlyCheck, params) {
    return new Promise(resolve => dbConnect(onlyCheck, params || {}, params => resolve(params)));
}
/**
 * Disconnect the database
 */
export async function resetDbConnect() {
    if (objects) {
        await objects.destroy();
        objects = null;
    }
 ...
 */
export async function exitApplicationSave(exitCode) {
