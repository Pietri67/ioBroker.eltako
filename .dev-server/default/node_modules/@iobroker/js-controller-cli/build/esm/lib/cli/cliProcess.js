...
import { isLocalStatesDbServer, isLocalObjectsDbServer, getInstancesOrderedByStartPrio, } from '@iobroker/js-controller-common';
...
export class CLIProcess extends CLICommand {
    ...
    async startJSController() {
        let memoryLimitMB = 0;
        try {
            const config = fs.readJSONSync(tools.getConfigFileName(), { encoding: 'utf-8' });
