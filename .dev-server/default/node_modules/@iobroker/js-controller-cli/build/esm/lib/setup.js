...
function initYargs() {
    _yargs = yargs(process.argv.slice(2))
        ...
        .command('start [all|<adapter>.<instance>|<adapter>]', 'Starts the js-controller or a specified adapter instance or all instances of an adapter', yargs => {
        yargs
            .command('all', 'Starts js-controller and all adapters')
            .command('<adapter>[.<instance>]', 'Starts a specified adapter instance');
    })
        .command('stop [<adapter>.<instance>|<adapter>]', 'stops the js-controller or a specified adapter instance or all instances of an adapter', yargs => {
        yargs.command('<adapter>[.<instance>]', 'Stops a specified adapter instance');
    })
        .command(['restart [<adapter>.<instance>|<adapter>]', 'r [<adapter>.<instance>|<adapter>]'], 'Restarts js-controller or a specified adapter instance or all instances of an adapter', yargs => {
        ...
        .command('url <url> [<name>]', 'Install adapter from specified url, e.g. GitHub, if a package name is provided instead of an url, it will be installed from npm', {})
            ...
            setup.setup({
                callback: async () => {
                    ...
                    try {
                        ...
                        if (config.objects.options.retry_max_delay === 15_000 ||
                        ...
                        if (config.states.options.retry_max_delay === 15_000 ||
            ...
            dbConnect(params, async ({ objects }) => {
                try {
                    ...
                    for (const attr of Object.keys(data)) {
                        console.log(`${attr}${attr.length < 16 ? new Array(16 - attr.length).join(' ') : ''}: ${
                        ...
                        try {
                            ...
                            if (objs) {
                                ...
                                for (const row of objs.rows) {
                                    ...
                                    adapters.push(tools.isObject(row.value.common.name)
                    ...
                    objects.getObjectList({
                        ...
                        if (!err && arr?.rows) {
                            ...
                            for (const row of arr.rows) {
                                ...
                                count++;
                                objects.touch(row.value.common.name, '*', { user: 'system.user.admin' }, 
                    ...
                    objects.getObjectList({
                        ...
                        if (!err && arr?.rows) {
                            ...
                            for (const row of arr.rows) {
                                ...
                                count++;
                                objects.rm(row.value.common.name, '*', { user: 'system.user.admin' }, 
                    ...
                    objects.getObjectList({
                        ...
                        if (!err && arr?.rows) {
                            ...
                            for (const row of arr.rows) {
                                ...
                                count++;
                                objects.chmodFile(row.value.common.name, '*', {
                    ...
                    objects.getObjectList({
                        ...
                        if (!err && arr?.rows) {
                            ...
                            for (const row of arr.rows) {
                                ...
                                count++;
                                objects.chownFile(row.value.common.name, '*', {
                                    user: 'system.user.admin',
                                    owner: user,
                                    ownerGroup: group,
                                }, 
