 ...
 */
export function formatValue(val, pretty = false) {
 ...
 */
export function validateAdapterIdentifier(name) {
 ...
 */
export function validateAdapterOrInstanceIdentifier(name) {
 ...
 * @param name the adapter name or instance
 */
export function splitAdapterOrInstanceIdentifierWithVersion(name) {
 ...
 */
export function getInstanceName(instanceObjID) {
 ...
 */
export async function enumInstances(objects, adapter) {
 ...
 */
export function enumHosts(objects) {
 ...
 */
export function enumObjects(objects, type, startkey) {
