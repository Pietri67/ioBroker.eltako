...
const i18n_1 = require("@iobroker/i18n");
...
class Admin extends adapter_core_1.Adapter {
    ...
    async onReady() {
        ...
        if (systemConfig) {
            ...
            i18n_1.default.init(__dirname, systemLanguage).catch(e => this.log.error(`Cannot init i18n: ${e}`));
        ...
        if (obj.command === 'admin:getNotificationSchema') {
            ...
            if (alreadyDone?.result === true) {
                schema = {
                    ...
                    items: {
                        _info: {
                            type: 'staticText',
                            text: i18n_1.default.getTranslatedObject('The password for user "%s" was successfully changed', guiMessage.login),
                            style: { color: 'green' },
                            sm: 12,
                        },
                    },
                ...
                schema = {
                    ...
                    items: {
                        _info: {
                            type: 'staticText',
                            text: i18n_1.default.getTranslatedObject('Cannot change password for %s:', guiMessage.login),
                            style: { color: 'orange' },
                            sm: 12,
                        },
                        _info1: {
                        ...
                        _info3: {
                            newLine: true,
                            type: 'staticText',
                            text: i18n_1.default.getTranslatedObject('Enter your new password by prompt.'),
                            style: { fontFamilies: 'monospace', color: 'green', backgroundColor: 'black' },
                            sm: 12,
                        },
                    },
                ...
                schema = {
                    ...
                    items: {
                        _info: {
                            type: 'header',
                            size: 5,
                            text: i18n_1.default.getTranslatedObject(`User "%s" has well known password. We suggest to change it.`, guiMessage.login),
                            style: { color: 'orange' },
                            sm: 12,
                        },
                        password: {
                            newLine: true,
                            label: i18n_1.default.getTranslatedObject('New password'),
                            type: 'password',
                            help: i18n_1.default.getTranslatedObject('Minimal length is 6 chars'),
                            visible: true,
                            sm: 12,
                            md: 6,
                        },
                        passwordRepeat: {
                            label: i18n_1.default.getTranslatedObject('Password repeat'),
                            type: 'password',
                            visible: true,
                            sm: 12,
                            md: 6,
                        ...
                        _send: {
                            ...
                            label: i18n_1.default.getTranslatedObject('Set password'),
                ...
                schema = {
                    ...
                    items: {
                        _info: {
                            type: 'staticText',
                            text: i18n_1.default.getTranslatedObject('This message is no more actual and was generated by other instance start'),
                            style: { color: 'grey' },
                            sm: 12,
                        },
                    },
            ...
            if (!guiMessage.password) {
                this.sendTo(obj.from, obj.command, {
                    command: {
                        command: 'message',
                        message: i18n_1.default.getTranslatedObject("Empty password isn't allowed"),
                        refresh: true,
                    },
                }, obj.callback);
            }
                ...
                this.sendTo(obj.from, obj.command, {
                    command: {
                        command: 'message',
                        message: i18n_1.default.getTranslatedObject('Password and password repeat are not equal'),
                        refresh: true,
                    },
                }, obj.callback);
            }
                ...
                this.sendTo(obj.from, obj.command, {
                    command: {
                        command: 'message',
                        message: i18n_1.default.getTranslatedObject('Password is too short (min 6 chars)'),
                        refresh: true,
                    },
                }, obj.callback);
            }
                ...
                void (0, checkLinuxPass_1.setLinuxPassword)(guiMessage.login, guiMessage.oldPassword, guiMessage.password).then(result => {
                    ...
                    if (result === true) {
                        this.sendTo(obj.from, obj.command, {
                            command: {
                                command: 'message',
                                message: i18n_1.default.getTranslatedObject('Password successfully changed for "%s"', guiMessage.login),
                                refresh: true,
                            },
                        }, obj.callback);
                    }
                        ...
                        this.sendTo(obj.from, obj.command, {
                            command: {
                                command: 'message',
                                message: i18n_1.default.getTranslatedObject(`Cannot change password for "%s": %s`, guiMessage.login, result),
                                style: { color: 'red' },
                                refresh: true,
                            },
                        }, obj.callback);
    ...
    initSocket(server, store) {
        ...
        { listen: (server) => new ws_server_1.SocketIO(server) }, {
            userKey: 'connect.sid',
            store,
            secret: this.secret,
        });
    ...
    async checkCommonObjects() {
        ...
        if (objects) {
            ...
            let userData = await this.getForeignObjectAsync('0_userdata.0');
            if (!userData) {
                userData = {
                    _id: '0_userdata.0',
                    type: 'meta',
    ...
    async validateUserData0() {
        ...
        if (!obj) {
            try {
                ...
                this.log.error(`Cannot read ${adapter_core_1.controllerDir}/io-package.json: ${e}`);
            }
        }
    }
    async checkWellKnownPasswords() {
        ...
        if (found) {
            ...
            await this.registerNotification('admin', 'wellKnownPassword', i18n_1.default.translate('User: %s', found.login), {
                contextData: {
                    admin: {
                        notification: {
                            login: found.login,
                            password: found.password,
                            offlineMessage: i18n_1.default.getTranslatedObject('Offline message', found.login),
                        },
                    },
                },
            });
